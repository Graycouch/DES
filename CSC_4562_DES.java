package csc_4562_des;

import java.util.HashMap;
import java.util.Scanner;

public class CSC_4562_DES {

    public static void main(String args[]) {
        Scanner input = new Scanner(System.in);
        System.out.print("Enter An Alphanumeric Plaintext That Is 16 Digits Long: ");
        String plaintext = input.nextLine();
        System.out.println();

        String key = "AABB09182736CCDD";
        CSC_4562_DES cipher = new CSC_4562_DES();
        System.out.println("Encryption:\n");
        plaintext = cipher.encrypt(plaintext, key);
        System.out.println("\nCipher Text: " + plaintext.toUpperCase() + "\n");
